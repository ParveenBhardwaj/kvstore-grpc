...
const file_kvstore_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\tR\x05value2\x99\x01\n" +
	"\aKVStore\x12*\n" +
	"\x03Set\x12\x13.kvstore.SetRequest\x1a\x0e.kvstore.Empty\x120\n" +
	"\x03Get\x12\x13.kvstore.GetRequest\x1a\x14.kvstore.GetResponse\x120\n" +
	"\x06Delete\x12\x16.kvstore.DeleteRequest\x1a\x0e.kvstore.EmptyB\fZ\n" +
	"/kvstorepbb\x06proto3"
...
var file_kvstore_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_kvstore_proto_depIdxs = []int32{
	...
	1, // 1: kvstore.KVStore.Get:input_type -> kvstore.GetRequest
	2, // 2: kvstore.KVStore.Delete:input_type -> kvstore.DeleteRequest
	3, // 3: kvstore.KVStore.Set:output_type -> kvstore.Empty
	4, // 4: kvstore.KVStore.Get:output_type -> kvstore.GetResponse
	3, // 5: kvstore.KVStore.Delete:output_type -> kvstore.Empty
